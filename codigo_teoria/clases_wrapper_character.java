...
public class clases_wrapper_character {
  public static void main(String[] args) {
    ...
    Character c1 = 'c';
    Character c2 =
        new Character('a'); // En versiones nuevas está deprecado (obsoleto). IntelliJ lo tacha por
    // innecesario.

    // Devuelve el valor equivalente
    Character c3 = 'b';
    char c4 = c3.charValue(); // lo que hace es devolver el char interno que alberga este Character

    // Método estático que comprueba si es minúscula. Puede invocarse sin necesidad de declarar un
    // Character
    ...
    Character m = Character.valueOf('h');
