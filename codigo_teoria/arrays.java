...
public class arrays {
  public static void main(String[] args) {
    ...
    // Podemos imprimir un elemento de un array con el operador [], accediendo a su índice.
    // OJO, los arrays empiezan en 0.
    System.out.println(a[0]);

    // Para obtener la longitud de un array, usamos la propiedad length.
    System.out.println(a.length);

    // También podemos imprimir todos los elementos de un array con un bucle for.
